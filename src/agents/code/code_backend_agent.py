...
class CodeBackendAgent(BaseAgent):
    ...
    def _register_capabilities(self) -> None:
        ...
        self.add_capability(
            Capability(name="generate_code", description="Generar código fuente", version="1.0.0")
        )
        self.add_capability(
            Capability(
                name="refactor_code", description="Refactorizar código existente", version="1.0.0"
            )
        )
        self.add_capability(
            Capability(
...
''',
    ...
    async def _generate_code(self, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        for module in modules:
            ...
            generated[module] = {"file_path": module_obj.file_path, "content": content}
    ...
    async def _refactor_code(self, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "changes": [
                "Method extracted" if refactor_type == "extract_method" else "Renamed variables"
            ],
        }
    ...
    async def _generate_documentation(self, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        return {"documentation": docs, "format": "sphinx", "count": len(docs)}
    ...
    def _generate_model(self, entity_name: str) -> str:
        ...
        return template.format(class_name=entity_name, table_name=entity_name.lower() + "s")
