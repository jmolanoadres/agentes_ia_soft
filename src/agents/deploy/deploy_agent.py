...
class DeployAgent(BaseAgent):
    ...
    def _register_capabilities(self) -> None:
        ...
        self.add_capability(Capability(
            ...
            description="Crear pipeline de CI/CD",
            version="1.0.0"
        ))
        self.add_capability(Capability(
            name="configure_deployment",
            description="Configurar despliegue",
            version="1.0.0"
        ))
        self.add_capability(Capability(
            name="execute_deployment",
            description="Ejecutar despliegue",
            version="1.0.0"
        ))
        self.add_capability(Capability(
            name="rollback",
            description="Realizar rollback",
            version="1.0.0"
        ))
        self.add_capability(Capability(
            name="manage_secrets",
            description="Gestionar secretos",
            version="1.0.0"
        ))
