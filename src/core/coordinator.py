...
class Coordinator:
    ...
    async def submit_task(self, task: Task, agent_id: str | None = None) -> TaskResult:
    ...
    async def create_workflow(self, workflow_name: str, input_data: dict[str, Any]) -> str:
    ...
    async def get_workflow_status(self, workflow_id: str) -> Workflow | None:
