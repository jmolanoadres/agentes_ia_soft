...
from src.agents.base.agent_protocol import AgentMessage
...
class MessageBroker:
    ...
    def __init__(self, max_queue_size: int = 100) -> None:
        ...
        self._subscribers: dict[str, list[Callable[[AgentMessage], Awaitable[Any]]]] = {}
    ...
    async def publish(self, message: AgentMessage) -> None:
        ...
        if receiver not in self._queues:
            self._queues[receiver] = MessageQueue(
                id=str(uuid.uuid4()), receiver=receiver, max_size=self._max_queue_size
            )
    ...
    async def subscribe(self, receiver: str, callback: Callable[[AgentMessage], Any]) -> None:
    ...
    async def unsubscribe(self, receiver: str, callback: Callable[[AgentMessage], Any]) -> None:
    ...
    async def consume(self, receiver: str) -> AgentMessage | None:
    ...
    async def peek(self, receiver: str) -> AgentMessage | None:
    ...
    async def _notify_subscribers(self, receiver: str, message: AgentMessage) -> None:
    ...
    def get_queue_stats(self) -> dict[str, Any]:
        ...
        for receiver, queue in self._queues.items():
            stats[receiver] = {"pending": len(queue.messages), "max_size": queue.max_size}
